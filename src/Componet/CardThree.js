...
import S from '../Assets/old.jpg'
import S2 from '../Assets/s.png'
        ...
        return(
            ...
            <div style={{display:"flex",justifyContent:"space-between",padding:"5px",marginLeft:"3px"}}>
                <div style={{display:"flex",flexWrap:"wrap"}}>
                    <img src={S} alt="A" style={{width:"50px",height:"50px",borderRadius:"50px"}}/>
                    <div style={{display:"block"}}>
                    <h4 style={{padding:"5px",marginLeft:"3px"}}>Paulina Lam</h4>
            ...
            <div style={{display:"block"}}>
                <div style={{display:"flex",flexWrap:"wrap",margin:"7px",padding:"2px"}}>
                   <img src={S2} alt="L" style={{margin:"3px",width:"20px",padding:"20px"}}/>
